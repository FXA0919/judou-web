...
- 初次上线全站每天最多生成 3,000 字符，每个 IP 每天最多 1,000 字符。以当前 Aura 2 每千字符 0.03 美元和 Workers AI 每天 10,000 Neurons 免费额度估算，3,000 字符约用掉 8,182 Neurons，给其他消耗留一点余量。若账号还运行其他 AI 服务，可能更早触及额度。Workers Free 达到额度后会报错，网页会尝试设备语音。

...
import type { DetectResult, FlattenedPaddleOcrResult, PaddleOcrResult } from "../core/base-paddle-ocr.service.js";
...
export declare function ocr(image: ArrayBuffer | CanvasLike, options: PaddleOptions & RecognizeOptions & {
    flatten: true;
...
export declare function detect(image: ArrayBuffer | CanvasLike, options?: PaddleOptions & DetectOptions): Promise<DetectResult>;

...
export declare function runOneShot<TService extends {
    initialize(): Promise<void>;
    destroy(): Promise<void>;
}, TResult>(createService: () => TService, run: (service: TService) => Promise<TResult>): Promise<TResult>;
...
export type SplitOptions<T> = {
    ...
    perCall: Omit<T, keyof PaddleOptions>;
};
/**
 ...
 */
export declare function splitOptions<T extends object>(options?: PaddleOptions & T): SplitOptions<T>;

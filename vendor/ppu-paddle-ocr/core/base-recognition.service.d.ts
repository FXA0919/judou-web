...
import type { Box, DebuggingOptions, ProcessingEngine, RecognitionOptions, RecognitionStrategy, RecognizeOptions } from "../interface.js";
...
export declare class BaseRecognitionService {
     ...
     */
    run(image: ArrayBuffer | CoreCanvas, detection: Box[], charactersDictionary?: string[], strategy?: RecognitionStrategy, perCallOptions?: RecognizeOptions): Promise<RecognitionResult[]>;
    /**

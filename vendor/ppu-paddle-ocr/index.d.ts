...
export declare function ocr(image: ArrayBuffer | Canvas, options: PaddleOptions & RecognizeOptions & {
    flatten: true;
...
export declare function detect(image: ArrayBuffer | Canvas, options?: PaddleOptions & DetectOptions): Promise<DetectResult>;
